    ...
    this.performTest = function (n, driver) {
        if (n < testList.length) {
            ...
            if (type == "delay") {
                ...
                var promise = driver.wait(thisHolder.until.elementLocated(elemToWait), 10000);
                ...
                promise.then(function (element) {
                    if (type == "click" || type == "clickXpath") {
                        ...
                        var input = driver.findElement({
                            ...
                            "//*[text()='" + label + "']/parent::*/parent::*/following-sibling::*[1]/descendant-or-self::input)[1]"
                        });
